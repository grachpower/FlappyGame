...
mainMenuState.prototype = {
	...
	create: function () {
		...
		if (lastScore > 0) {
			this.game.add.text(160, 170, 'Your last score: ' + lastScore, {
				fontSize: '30px',
				fontFamily: 'Times',
				fill: 'blue',
			});
		...
		this.game.add.text(220, 350, 'Tap to start', {
			fontSize: '24px',
			fontFamily: 'Roboto',
			fill: 'cyan',
		});
		...
		setTimeout(function (){
			...
			for (var i = 0; i < 10; i++){
				this.game.add.text(40, this.deftextheight, topUsers[i].user + ": " + topUsers[i].score, {
					fontSize: '16px',
					fontFamily: 'Roboto',
					fill: 'green',
				});
